...
hybrid_classifier.setLowerThreshold(-0.88)
hybrid_classifier.setUpperThreshold(0.88)
...
cross.setResultPath("../../../results/complete_attribute/hybrid_oculta_088_088_42/")
