...
hybrid_classifier.setLowerThreshold(-0)
hybrid_classifier.setUpperThreshold(1)
...
cross.setResultPath("../../../results/complete_attribute/hybrid_00_100_oculta42_knnbrute_time_melhorado_tentando1/")
