...
hybrid_classifier.setLowerThreshold(-0.91)
hybrid_classifier.setUpperThreshold(0.91)
...
cross.setResultPath("../../../results/complete_attribute/hybrid_oculta_091_091_42/")
