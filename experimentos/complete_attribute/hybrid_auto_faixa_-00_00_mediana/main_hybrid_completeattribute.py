...
hybrid_classifier.setLimiteFaixaInf(-0.0)
hybrid_classifier.setLimiteFaixaSup(0.0)
...
cross.setResultPath("../../../results/complete_attribute/hybrid_auto_faixa_-00_00_mediana/")
